...
client.user.setGame(`!!help|Monster Bot|2018`,"http://twitch.tv/S-F")
  console.log('')
  console.log('')
  console.log('╔[═════════════════════════════════════════════════════════════════]╗')
...
function timeCon(time) {
  ...
  client.on("ready", () => {
    ...
    while (!guild)
        ...
        guild = client.guilds.get("475372116552974337 - Server id");
...
client.on("guildMemberAdd", (member) => {
    ...
    let channel = member.guild.channels.get("475373758408818688 - Room id");
